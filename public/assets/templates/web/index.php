                ...
                <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="service-item position-relative">
                            ...
                            <p>Veja quais dados pessoais são coletados e a origem desses dados.</p>
                            <a href="page2.php" class="readmore stretched-link">Saiba mais <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div><!-- End Service Item -->
